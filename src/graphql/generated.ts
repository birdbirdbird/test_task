...
function fetcher<TData, TVariables>(query: string, variables?: TVariables) {
  return async (): Promise<TData> => {
    const res = await fetch("http://152.228.215.94:83/api", {
    method: "POST",
...
export const ApplicantIndividualCompanyPositionsDocument = `
  ...
  applicantIndividualCompanyPositions {
    ...
    `;
export const useApplicantIndividualCompanyPositionsQuery = <
      TData = ApplicantIndividualCompanyPositionsQuery,
      TError = unknown
    >(
      variables?: ApplicantIndividualCompanyPositionsQueryVariables,
      options?: UseQueryOptions<ApplicantIndividualCompanyPositionsQuery, TError, TData>
    ) =>
    useQuery<ApplicantIndividualCompanyPositionsQuery, TError, TData>(
      variables === undefined ? ['ApplicantIndividualCompanyPositions'] : ['ApplicantIndividualCompanyPositions', variables],
      fetcher<ApplicantIndividualCompanyPositionsQuery, ApplicantIndividualCompanyPositionsQueryVariables>(ApplicantIndividualCompanyPositionsDocument, variables),
      options
    );
export const ApplicantIndividualCompanyRelationsDocument = `
  ...
  applicantIndividualCompanyRelations {
    ...
    `;
export const useApplicantIndividualCompanyRelationsQuery = <
      TData = ApplicantIndividualCompanyRelationsQuery,
      TError = unknown
    >(
      variables?: ApplicantIndividualCompanyRelationsQueryVariables,
      options?: UseQueryOptions<ApplicantIndividualCompanyRelationsQuery, TError, TData>
    ) =>
    useQuery<ApplicantIndividualCompanyRelationsQuery, TError, TData>(
      variables === undefined ? ['ApplicantIndividualCompanyRelations'] : ['ApplicantIndividualCompanyRelations', variables],
      fetcher<ApplicantIndividualCompanyRelationsQuery, ApplicantIndividualCompanyRelationsQueryVariables>(ApplicantIndividualCompanyRelationsDocument, variables),
      options
    );